      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light nav-fill">
        ...
        <table id="website">
            ...
            if (isset($_GET['delete_id'])) {
                ...
                $sql = "DELETE FROM online WHERE id = ?";
            ...
            $sql = "SELECT id,name, category, address, pn, email, size, s1, materialColor, costume, heel, hyperlink, detail, requiredDate, orderPrice FROM online";
