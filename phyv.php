    ...
    <div class="container">
        ...
        <table id="website">
            ...
            if (isset($_GET['name'])) {
                ...
                $stmt = $conn->prepare("SELECT name, category, address, pn, email, size, s1, materialColor, costume, heel, hyperlink, detail, requiredDate, orderPrice FROM phy WHERE name = ?");
